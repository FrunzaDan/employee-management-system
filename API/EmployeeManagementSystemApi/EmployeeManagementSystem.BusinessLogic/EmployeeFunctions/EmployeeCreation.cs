...
public class EmployeeCreation(IDbUtils dbUtils, IEmployeeAuditLogger auditLogger)
{
    ...
    public async Task<ResponseModel<Guid?>> CreateEmployeeFunction(CreateEmployeeRequest request, string performedBy,
        CancellationToken cancellationToken = default)
    {
        ...
        var response = await dbUtils.CreateEmployee(request, cancellationToken);
